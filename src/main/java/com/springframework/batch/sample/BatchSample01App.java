...
public class BatchSample01App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext(contextConfigLocations)) {
            Job helloBatchJob = (Job) applicationContext.getBean("helloBatchJob");
...
//            }
            jobLauncher.run(helloBatchJob, new JobParametersBuilder().addLong("REQ_ID", 1L, true).addLong("MULTI_PROC_NO", 1L, true).toJobParameters());
